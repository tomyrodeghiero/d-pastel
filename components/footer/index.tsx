            ...
            <div className="max-w-5xl mx-auto flex flex-col lg:flex-row justify-between pb-10">
                <div className="mb-4 lg:mb-0 w-full">
                    <Link href="/" data-aos="fade-up">
                        <img src={D_PASTEL_LOGOTYPE} alt="Logo" data-aos="fade-up" className="h-28 mx-auto lg:mx-0" />
                    </Link>
                    <p data-aos="fade-up" className="text-gray-500 leading-5 text-center lg:text-left text-xl lg:text-lg">La atención al detalle es lo que<br />define nuestros espacios.</p>

                    <div data-aos="fade-up" className="flex gap-4 mt-4 w-full justify-center lg:justify-start">
                ...
                <div data-aos="fade-up" className="flex mt-4 lg:mt-0 lg:w-full justify-between w-3/4 mx-auto gap-16 lg:justify-end lg:gap-8">
                    ...
                    <div className="md:w-auto">
                        ...
                        <div className="flex flex-col gap-8 text-gray-500 font-family-jost text-lg">
                            ...
                            <Link href="/shop">
                                <span className="navlink">infod.pastel@gmail.com</span>
                            </Link>
                            <Link href="/shop">
