...
const Newsletter = () => {
    ...
    return (
        <div className="flex justify-center items-center py-10 lg:py-20 px-4 lg:px-0" data-aos="fade-up">
            ...
            {showModal && (
                <div className="fixed font-family-jost inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center transition-opacity duration-500 ease-in-out">
                    <div ref={modalRef} data-aos="fade-up" className="bg-white p-8 rounded-lg animate-fade-in-up">
                        ...
                        />
                        <button onClick={handleSubscribe} className="bg-gray-900 w-full flex justify-center gap-2 font-family-jost text-white font-semibold rounded-2xl py-4 px-5 items-center">
                            Subscribirse
