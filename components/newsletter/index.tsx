...
const Newsletter = () => {
    return (
        <div className="flex justify-center items-center py-20">
            <div className="w-3/5 rounded-3xl bg-gray-900 py-12">
                <h2 className="text-4xl text-white mb-4 text-center">¿Quieres unirte a D-pastel?</h2>
                ...
                <button className="mx-auto bg-gold-500 mt-8 gap-2 font-family-jost text-white font-semibold rounded-2xl py-4 px-5 flex items-center">
